...
const double highpass_coeff = 0.9; // highpass filter coefficient
const double lowpass_coeff = 0.1; // lowpass filter coefficient
const std::chrono::milliseconds peak_hold_time(2);
double sensitivity = 1.0; // Adjust this to change sensitivity
